...
Обновлено после раунда v0.9.6 (волна красной команды «межкомнатные сокеты»: приватный home/tmp закрыл shared-cache и X11-сокет; задокументирован остаточный вектор «активация на хосте из игровых комнат»; netcat/nmap-эксфил-инструменты в чёрный список комнат).
